...
public class Main {
	public static void main(String[] args) {
		...
		if (renda <= 2000.00) System.out.println("Isento");
		 
		else {
			if (renda > 4500.00) {
				calculo = renda - 4500.00;
				renda = 4500.00;
				imposto += calculo * 0.28;
			}

			if (renda > 3000.00) {
				calculo = renda - 3000.00;
				renda = 3000.00;
				imposto += calculo * 0.18;
			}

			if (renda > 2000.00) {
				calculo = renda - 2000.00;
				imposto += calculo * 0.08;
			}
